...
console.log(person.firstName === personTwo.firstName); // output //Doe
...
// Your code goes here
let questionClone =[ { ...questions[0],responses:[...question[0].responses]},{...question[1],reponse:[...question[1].responses]}]
```
...
let clonedPerson=
JSON.prase(JSON.stringify(person));
```
...
function cloneObject(obj) {
  // your code
 return  JSON.prase(JSON.stringify(obj));
