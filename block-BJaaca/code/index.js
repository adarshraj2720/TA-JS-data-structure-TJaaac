...
character.greet=`she is ${character.characterName} and her title is ${character.title}`
// - Check by calling `greet` and see if the message changed or not.

character.greet;
yes message has changed because re-assign the value in greet.
